...
/**
 * Created by kmy on 2017/9/10.
 */

public class SearchNewsAccesser {
    ...
    SearchNewsAccesser (int newsNum, int category, String newsKeywords){
        stringBuilder = new StringBuilder();
        try {
            int pageNo = (newsNum + 20) / 20;
            String UrlString = "http://166.111.68.66:2042/news/action/query/search?keyword="+newsKeywords+"&pageNo="+pageNo;
            if (category != 0)
